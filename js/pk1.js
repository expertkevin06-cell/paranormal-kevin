const DEFAULTS={
 mode:'camthlidar',layers:{rgb:true,th:true,depth:true},fusionMode:'panel',
 ...
 usb:{vid:'',pid:'',iface:0,epIn:130,fmt:'u16temp',w:256,h:192,hdr:0,magic:'',endian:'le',scale:0.01,offset:0,pkt:16384,native:true}};
const S=(()=>{try{return Object.assign(structuredClone(DEFAULTS),JSON.parse(localStorage.getItem('pk9.s')||'{}'));}catch{return structuredClone(DEFAULTS);}})();
const save=()=>localStorage.setItem('pk9.s',JSON.stringify(S));
...
const runtime={online:navigator.onLine,net:'—',tier:'medium',rgb:null,depth:null,boxes:[],temps:null,
 ...
 near:0,mag:0,para:0,px:2,thSrc:'—',boot:[],lastRenderErr:'',probe:null};
let pdb;
const db=()=>pdb??=new Promise((res,rej)=>{const r=indexedDB.open('paranormal9',1);
